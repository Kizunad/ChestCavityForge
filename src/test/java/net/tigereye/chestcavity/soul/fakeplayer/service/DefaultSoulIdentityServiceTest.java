...
class DefaultSoulIdentityServiceTest {
    ...
    void ensureIdentityCopiesSourceProfileAndTrimsName() {
        ...
        assertEquals(source.getId(), identity.getId(), "identity should reuse source profile id when allowed");
        assertEquals(longName.substring(0, 16), identity.getName(), "name should be trimmed to 16 chars");
