...
final class ShouPiQianJiaCrashCalculatorTest {
  ...
  void computeCapsDamageAgainstSoftPool() {
    ...
    assertEquals(ShouPiGuOrganBehavior.CRASH_SPLASH_RADIUS, params.radius(), 1.0E-6);
  }
  ...
  void computeDualSynergyIncreasesDamageAndRadius() {
    ...
    assertEquals(
        ShouPiGuOrganBehavior.CRASH_SPLASH_RADIUS + ShouPiQianJiaCrashTuning.DUAL_RADIUS_BONUS,
        params.radius(),
        1.0E-6);
  }
}
