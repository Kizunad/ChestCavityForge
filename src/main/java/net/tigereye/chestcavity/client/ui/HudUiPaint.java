...
/**
 * Shared HUD/Toast paint helpers to keep a consistent look
 * (card background, simple drop shadow, icon blit, and colors).
 */
public final class HudUiPaint {
    ...
    /**
     * Draw a horizontal progress bar with a small shadow.
     * progress in [0,1].
     */
