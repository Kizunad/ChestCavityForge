...
public class TestHudOverlay {
    ...
    private static volatile ResourceLocation icon = ResourceLocation.parse("modernui:textures/item/project_builder.png");
    private static volatile net.minecraft.world.item.ItemStack itemIcon = net.minecraft.world.item.ItemStack.EMPTY;
