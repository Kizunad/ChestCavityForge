...
/**
 * Debug container menu used to validate Modern UI + NeoForge inventory bridging. Provides a simple
 * 3x3 storage grid backed by a {@link SimpleContainer}, plus the player's inventory slots.
 */
