...
public final class ResourceDocProvider implements DocProvider {
    ...
    public Collection<DocEntry> loadAll() {
        ...
        Map<ResourceLocation, Resource> resources = manager.listResources(ROOT, location -> location.getNamespace().equals(NAMESPACE) && location.getPath().endsWith(".json"));
        ...
        for (Map.Entry<ResourceLocation, Resource> entry : resources.entrySet()) {
            ...
            try (var reader = new BufferedReader(new InputStreamReader(entry.getValue().open(), StandardCharsets.UTF_8))) {
