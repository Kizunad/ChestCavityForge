...
public class ShuangXiGuPassive implements PassiveHook {
    ...
    public void onTick(LivingEntity owner, ChestCavityInstance cc, long now) {
        ...
        ShuangXiGuOrganBehavior.INSTANCE.onSlowTick(owner, cc, organ);
        if(owner.onGround()){
            ShuangXiGuOrganBehavior.INSTANCE.onGroundTick(owner, cc, organ);
        }
    }
