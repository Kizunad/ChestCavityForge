...
public enum ShouPiGuCrashActive {
  INSTANCE;

  static {
    OrganActivationListeners.register(
        ShouPiGuTuning.ACTIVE_CRASH_ID, ShouPiGuCrashActive::onActivate);
  }
  ...
  public static void onActivate(LivingEntity entity, ChestCavityInstance cc) {
    ...
    ShouPiRuntime.activateCrash(player, cc, entity.level().getGameTime());
  }
}
