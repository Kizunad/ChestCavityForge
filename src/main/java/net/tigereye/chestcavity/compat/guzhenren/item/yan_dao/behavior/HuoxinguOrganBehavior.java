...
public final class HuoxinguOrganBehavior extends AbstractGuzhenrenOrganBehavior
  ...
  private static final float BURN_HEAL_AMOUNT =
      BehaviorConfigAccess.getFloat(HuoxinguOrganBehavior.class, "BURN_HEAL_AMOUNT", 4.0f);
  private static final float BURN_JINGLI_REPLENISH =
      BehaviorConfigAccess.getFloat(HuoxinguOrganBehavior.class, "BURN_JINGLI_REPLENISH", 3.0f);
  ...
  public void onSlowTick(LivingEntity entity, ChestCavityInstance cc, ItemStack organ) {
    ...
    if (!payment.succeeded()) {
      if (LOGGER.isDebugEnabled()) {
        LOGGER.debug(
            "[compat/guzhenren][yan_dao][huoxingu] insufficient resources for {} (reason={})",
