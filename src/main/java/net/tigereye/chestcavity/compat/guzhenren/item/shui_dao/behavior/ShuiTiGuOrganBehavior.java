...
public final class ShuiTiGuOrganBehavior extends AbstractGuzhenrenOrganBehavior
  ...
  private static final ResourceLocation SHUI_SHEN_GU_ID =
  ...
  private static final float HEAL_PER_SECOND =
      BehaviorConfigAccess.getFloat(ShuiTiGuOrganBehavior.class, "HEAL_PER_SECOND", 3.0f);
  private static final double ZHENYUAN_PER_SECOND = 200.0;
  private static final int SHIELD_CHARGE_PER_TICK =
      BehaviorConfigAccess.getInt(ShuiTiGuOrganBehavior.class, "SHIELD_CHARGE_PER_TICK", 2);
  ...
  public void onEquip(
      ...
      ItemStack organ,
      java.util.List<OrganRemovalContext> staleRemovalContexts) {
  ...
  public void onRemoved(LivingEntity entity, ChestCavityInstance cc, ItemStack organ) {
    ...
    context.lookupChannel(SHUI_DAO_INCREASE_EFFECT).ifPresent(channel -> channel.adjust(-removed));
