...
public final class QuanYongMingGuOrganBehavior extends AbstractGuzhenrenOrganBehavior
  ...
  private static final float PURE_WATER_ABSORPTION =
      BehaviorConfigAccess.getFloat(
          QuanYongMingGuOrganBehavior.class, "PURE_WATER_ABSORPTION", 10.0f);
  ...
  private void refreshIncreaseContribution(
      ChestCavityInstance cc, ItemStack organ, boolean primary) {
    if (cc == null || organ == null || organ.isEmpty()) {
      return;
    }
    ActiveLinkageContext context = LinkageManager.getContext(cc);
