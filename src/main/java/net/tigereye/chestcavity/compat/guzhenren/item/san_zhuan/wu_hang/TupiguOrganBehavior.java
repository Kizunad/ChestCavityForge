...
public enum TupiguOrganBehavior
  ...
  private static final int JUMP_EFFECT_TICKS =
      BehaviorConfigAccess.getInt(TupiguOrganBehavior.class, "JUMP_EFFECT_TICKS", 40);
  private static final int JUMP_AMPLIFIER =
      BehaviorConfigAccess.getInt(TupiguOrganBehavior.class, "JUMP_AMPLIFIER", 2);
              ...
              if (current == null || current.getDuration() <= JUMP_EFFECT_TICKS / 2) {
                player.addEffect(
                    new MobEffectInstance(
                        MobEffects.JUMP, JUMP_EFFECT_TICKS, JUMP_AMPLIFIER, false, false, true));
