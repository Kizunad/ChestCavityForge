...
public final class EffectOps {
  ...
  public static boolean applyById(
      LivingEntity target,
    ...
    target.addEffect(
        new MobEffectInstance(
            effect.get(), durationTicks, Math.max(0, amplifier), false, showParticles, showIcon));
    return true;
  }
  ...
  public static void ensure(
    ...
    target.addEffect(
        new MobEffectInstance(
            effect, durationTicks, Math.max(0, amplifier), false, showParticles, showIcon));
  }
  ...
  public static int applyToAllById(
