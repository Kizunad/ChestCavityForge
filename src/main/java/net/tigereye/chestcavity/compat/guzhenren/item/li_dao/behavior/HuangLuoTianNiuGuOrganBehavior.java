...
/**
 * 黄骆天牛蛊（力道·肌肉）：
 * - 被动：每5秒尝试消耗100 BASE 真元，恢复3点精力（若已满则跳过）。
 * - 主动（ATTACKABILITY）：召唤一只“发疯的牛”直线冲锋；并给予施放者30秒“精力消耗减少”。冷却60秒，主动不可叠加。
 */
public final class HuangLuoTianNiuGuOrganBehavior extends AbstractLiDaoOrganBehavior implements OrganSlowTickListener {

    public static final HuangLuoTianNiuGuOrganBehavior INSTANCE = new HuangLuoTianNiuGuOrganBehavior();

    private static final String MOD_ID = "guzhenren";
    private static final ResourceLocation ORGAN_ID = ResourceLocation.fromNamespaceAndPath(MOD_ID, "huang_luo_tian_niu_gu");
    ...
    private static void activateAbility(LivingEntity entity, ChestCavityInstance cc) {
        ...
        player.addEffect(new MobEffectInstance(CCStatusEffects.HLTN_STAMINA_REDUCE, ACTIVE_STAMINA_REDUCE_SECONDS * 20, 0, false, /*visible*/true, /*showIcon*/true));
