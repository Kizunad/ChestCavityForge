...
/**
 * Registers organ score effects that proxy Guzhenren resource adjustments through {@link
 * GuzhenrenResourceBridge}. Only applies to player-owned chest cavities.
 */
public final class GuzhenrenOrganScoreEffects {
  ...
  private static void registerEffect(
      ...
      String... aliases) {
    OrganScoreEffects.Effect effect =
        (entity, chestCavity, previous, current) -> {
