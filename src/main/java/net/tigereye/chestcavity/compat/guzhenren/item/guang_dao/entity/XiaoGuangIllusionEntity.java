...
public class XiaoGuangIllusionEntity extends PathfinderMob {
  ...
  private static final EntityDataAccessor<Integer> AURA_COLOR =
      SynchedEntityData.defineId(XiaoGuangIllusionEntity.class, EntityDataSerializers.INT);
  private static final EntityDataAccessor<String> SKIN_TEXTURE =
      SynchedEntityData.defineId(XiaoGuangIllusionEntity.class, EntityDataSerializers.STRING);
  private static final EntityDataAccessor<String> SKIN_MODEL =
      SynchedEntityData.defineId(XiaoGuangIllusionEntity.class, EntityDataSerializers.STRING);
  private static final EntityDataAccessor<String> SKIN_URL =
      SynchedEntityData.defineId(XiaoGuangIllusionEntity.class, EntityDataSerializers.STRING);
  private static final EntityDataAccessor<String> SKIN_PROPERTY_VALUE =
      SynchedEntityData.defineId(XiaoGuangIllusionEntity.class, EntityDataSerializers.STRING);
  private static final EntityDataAccessor<String> SKIN_PROPERTY_SIGNATURE =
      SynchedEntityData.defineId(XiaoGuangIllusionEntity.class, EntityDataSerializers.STRING);
  ...
  public void setSkin(PlayerSkinUtil.SkinSnapshot snapshot) {
    ...
    int argb =
        ((int) (snapshot.alpha() * 255.0f) & 0xFF) << 24
    ...
    this.entityData.set(
        SKIN_PROPERTY_VALUE, snapshot.propertyValue() == null ? "" : snapshot.propertyValue());
    this.entityData.set(
        SKIN_PROPERTY_SIGNATURE,
        snapshot.propertySignature() == null ? "" : snapshot.propertySignature());
  }
  ...
  public void disperse(ServerLevel level) {
    ...
    level.sendParticles(
        ParticleTypes.END_ROD, pos.x, pos.y + 0.6, pos.z, 12, 0.25, 0.35, 0.25, 0.05);
    this.discard();
  }
  ...
  public static XiaoGuangIllusionEntity create(
      ServerLevel level, Player owner, Vec3 spawnPos, PlayerSkinUtil.SkinSnapshot skin) {
    XiaoGuangIllusionEntity illusion =
        net.tigereye.chestcavity.registration.CCEntities.XIAO_GUANG_ILLUSION.get().create(level);
    if (illusion == null) {
      return null;
    }
