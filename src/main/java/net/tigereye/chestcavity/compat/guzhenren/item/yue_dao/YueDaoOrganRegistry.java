...
public final class YueDaoOrganRegistry {
    ...
    private static final ResourceLocation MOONLIGHT_ID = ResourceLocation.fromNamespaceAndPath(MOD_ID, "yue_guang_gu");
    ...
    public static List<OrganIntegrationSpec> specs() {
        ...
        try {
            list.add(OrganIntegrationSpec.builder(MOONLIGHT_ID)
            ...
            ChestCavity.LOGGER.warn("[compat/guzhenren][yue_dao] skip MoonlightGu registration due to init error", t);
        }
        return list;
    }
}
