...
public final class LedgerOps {
    ...
    public static LinkageChannel ensureChannel(ActiveLinkageContext context, ResourceLocation channelId, ClampPolicy... policies) {
    ...
    public static void adjust(ChestCavityInstance cc, ItemStack organ, ResourceLocation channelId,
                              double delta, ClampPolicy policy, boolean verify) {
    ...
    /** Set absolute contribution for an organ and reconcile the channel (delta-applied), then optionally verify. */
    public static void set(ChestCavityInstance cc, ItemStack organ, ResourceLocation channelId,
                           int stackCount, double effect, ClampPolicy policy, boolean verify) {
    ...
    /** Remove organ contribution and reconcile the channel by subtracting the previous value; optionally verify. */
    public static void remove(ChestCavityInstance cc, ItemStack organ, ResourceLocation channelId,
                              ClampPolicy policy, boolean verify) {
        if (cc == null || organ == null || organ.isEmpty() || channelId == null) {
            return;
        }
        ActiveLinkageContext context = LinkageManager.getContext(cc);
