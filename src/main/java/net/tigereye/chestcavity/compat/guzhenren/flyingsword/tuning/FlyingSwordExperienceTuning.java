 ...
 * 核心公式：
 * <ul>
 *   <li>经验获取 = 造成伤害 × EXP_PER_DAMAGE × (击杀?EXP_KILL_MULT:1) × (精英?EXP_ELITE_MULT:1) × 额外倍率</li>
 *   <li>升级所需经验 = EXP_BASE × (1 + 当前等级) ^ EXP_ALPHA</li>
 *   <li>等级伤害加成 = 1 + (当前等级 - 1) × DAMAGE_PER_LEVEL / 基础伤害</li>
 * </ul>
 * <p>
 * 升级经验指数 EXP_ALPHA 说明：
 * 该参数控制升级曲线的陡峭程度，作为指数应用于 (1 + 当前等级) 的幂运算。
 * 当 EXP_ALPHA = 1.5 时，表示升级所需经验呈超线性增长，等级越高升级越困难。
 * 例如：从1级升2级需要 40 × (1+1)^1.5 ≈ 113 经验，而从99级升100级需要 40 × (1+99)^1.5 ≈ 40,000 经验。
 */
