...
public final class FlyingSwordExperienceTuning {
  ...
  public static final double EXP_PER_DAMAGE = 0.1;
  public static final int EXP_KILL_MULT = 5;
  public static final int EXP_ELITE_MULT = 2;
  public static final double EXP_BASE = 40.0;
  public static final double EXP_ALPHA = 1.5;
  public static final int MAX_LEVEL = 999;
  public static final double DAMAGE_PER_LEVEL = 9;
}
