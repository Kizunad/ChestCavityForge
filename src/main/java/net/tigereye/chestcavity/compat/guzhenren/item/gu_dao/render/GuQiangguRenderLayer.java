 ...
 */
public final class GuQiangguRenderLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    private static final ResourceLocation ORGAN_ITEM_ID = ResourceLocation.fromNamespaceAndPath("guzhenren", "gu_qiang_gu");
