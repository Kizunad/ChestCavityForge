...
public final class GuangDaoClientAbilities {
  ...
  public static void onClientSetup(FMLClientSetupEvent event) {
    ResourceLocation shanGuangId =
        ResourceLocation.fromNamespaceAndPath("guzhenren", "shan_guang_gu_flash");
    if (!CCKeybindings.ATTACK_ABILITY_LIST.contains(shanGuangId)) {
      CCKeybindings.ATTACK_ABILITY_LIST.add(shanGuangId);
    }
    ResourceLocation xiaoGuangId =
        ResourceLocation.fromNamespaceAndPath("guzhenren", "xiao_guang_illusion");
