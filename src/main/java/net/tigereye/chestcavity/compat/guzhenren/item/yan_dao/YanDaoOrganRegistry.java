...
public final class YanDaoOrganRegistry {
  ...
  private static final ResourceLocation HUO_YI_GU_ID =
  ...
  private static final ResourceLocation HUO_LONG_GU_ID =
  ...
  private static final ResourceLocation FEN_SHEN_GU_ID =
      ResourceLocation.fromNamespaceAndPath(MOD_ID, "fen_shen_gu");
  ...
  public static List<OrganIntegrationSpec> specs() {
    ...
    try {
      ...
      ChestCavity.LOGGER.warn(
          "[compat/guzhenren][yan_dao] skip Huoxingu registration due to init error", t);
    }
    try {
      list.add(
      ...
      ChestCavity.LOGGER.warn(
          "[compat/guzhenren][yan_dao] skip FenShenGu registration due to init error", t);
    }
    try {
      list.add(
      ...
      ChestCavity.LOGGER.warn(
          "[compat/guzhenren][yan_dao] skip HuoYiGu registration due to init error", t);
    }
    try {
      list.add(
          OrganIntegrationSpec.builder(DAN_QIAO_HUO_TAN_GU_ID)
              .addOnHitListener(HuoTanGuOrganBehavior.INSTANCE)
              .build());
    } catch (Throwable t) {
      ChestCavity.LOGGER.warn(
          "[compat/guzhenren][yan_dao] skip HuoTanGu registration due to init error", t);
    }
    try {
      list.add(
          OrganIntegrationSpec.builder(HUO_YOU_GU_ID)
              .addSlowTickListener(HuoYouGuOrganBehavior.INSTANCE)
              .addOnHitListener(HuoYouGuOrganBehavior.INSTANCE)
              .build());
    } catch (Throwable t) {
      ChestCavity.LOGGER.warn(
          "[compat/guzhenren][yan_dao] skip HuoYouGu registration due to init error", t);
    }
    try {
      list.add(
      ...
      ChestCavity.LOGGER.warn(
          "[compat/guzhenren][yan_dao] skip Huorengu registration due to init error", t);
    }
    try {
      list.add(
          OrganIntegrationSpec.builder(HUO_LONG_GU_ID)
      ...
      ChestCavity.LOGGER.warn(
          "[compat/guzhenren][yan_dao] skip HuoLongGu registration due to init error", t);
    }
    return list;
  }
}
