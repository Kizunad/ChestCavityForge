...
### 验收检查表
- [ ] **DoT 触发**：攻击后目标持续受到伤害，每秒 1 次
- [ ] **持续时间**：DoT 持续 5 秒（共 5 次伤害）
- [ ] **伤害计算正确**：
