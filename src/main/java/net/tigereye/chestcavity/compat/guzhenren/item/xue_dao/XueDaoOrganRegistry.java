...
public final class XueDaoOrganRegistry {
  ...
  private static final ResourceLocation TIE_XUE_GU_ID =
      ResourceLocation.fromNamespaceAndPath(MOD_ID, "tiexuegu");

  private static final ResourceLocation XUE_FEI_GU_ID =
      ResourceLocation.fromNamespaceAndPath(MOD_ID, "xie_fei_gu");

  private static final ResourceLocation XIE_DI_GU_ID =
      ResourceLocation.fromNamespaceAndPath(MOD_ID, "xie_di_gu");
  private static final ResourceLocation XUE_QI_GU_ID =
      ResourceLocation.fromNamespaceAndPath(MOD_ID, "xueqigu");
  private static final ResourceLocation XIE_YAN_GU_ID =
