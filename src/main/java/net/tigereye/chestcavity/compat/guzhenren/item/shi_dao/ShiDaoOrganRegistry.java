...
public final class ShiDaoOrganRegistry {
  ...
  private static final ResourceLocation JIU_CHONG_ID =
      ResourceLocation.fromNamespaceAndPath(MOD_ID, "jiu_chong");
  private static final ResourceLocation FAN_DAI_CAO_GU_ID =
      ResourceLocation.fromNamespaceAndPath(MOD_ID, "fan_dai_cao_gu");
