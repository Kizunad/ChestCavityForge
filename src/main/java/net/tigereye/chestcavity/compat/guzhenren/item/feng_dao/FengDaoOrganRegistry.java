...
/**
 * Declarative registration for 风道器官。
 */
public final class FengDaoOrganRegistry {

    private static final String MOD_ID = "guzhenren";
    private static final ResourceLocation QING_FENG_LUN_GU_ID = ResourceLocation.fromNamespaceAndPath(MOD_ID, "qing_feng_lun_gu");
    ...
    public static List<OrganIntegrationSpec> specs() {
        ...
        try {
            list.add(OrganIntegrationSpec.builder(QING_FENG_LUN_GU_ID)
            ...
            ChestCavity.LOGGER.warn("[compat/guzhenren][feng_dao] skip QingFengLunGu registration due to init error", t);
        }
        return list;
    }
}
