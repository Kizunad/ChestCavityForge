...
public final class SoulBeastIntimidationGoalManager {
  ...
  private static final class IntimidatedFleeGoal extends Goal {
    ...
    public boolean canUse() {
      ...
      if (this.intimidator.distanceToSqr(awayPos.x, awayPos.y, awayPos.z)
          <= this.intimidator.distanceToSqr(this.mob)) {
    ...
    public boolean canContinueToUse() {
      return this.path != null
          ...
          && this.intimidator.isAlive()
          && SoulBeastIntimidationGoalManager.hasIntimidator(this.mob);
    }

    @Override
    public void start() {
      LOGGER.info(
          "[Intimidation] {} starting flee from {}", describe(mob), describe(this.intimidator));
    ...
    public void tick() {
      ...
      this.mob
          .getNavigation()
          .setSpeedModifier(distanceSq < this.maxDistanceSq ? this.sprintSpeed : this.walkSpeed);
    }
