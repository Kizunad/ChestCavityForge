...
/**
 * Encapsulates the shield absorption logic for Shuishengu so it can be reused
 * or tested independently of the broader organ behaviour.
 */
public final class ShuishenguShield implements IncomingDamageShield {
    ...
    public static void broadcastChargeRatio(ChestCavityInstance cc, int maxCharge, int currentCharge) {
