...
/**
 * Client-side ability registrations for 血道 organs. Ensures Xue Dao active abilities share the
 * common attack keybinding on the client.
 */
public final class XueDaoClientAbilities {
  ...
  public static void onClientSetup(FMLClientSetupEvent event) {
    ...
    if (!CCKeybindings.ATTACK_ABILITY_LIST.contains(XueZhanGuOrganBehavior.ABILITY_ID)) {
      CCKeybindings.ATTACK_ABILITY_LIST.add(XueZhanGuOrganBehavior.ABILITY_ID);
    }
  }
}
