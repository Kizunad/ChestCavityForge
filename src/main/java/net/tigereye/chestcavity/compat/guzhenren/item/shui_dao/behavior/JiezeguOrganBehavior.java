...
public final class JiezeguOrganBehavior extends AbstractGuzhenrenOrganBehavior
    ...
    private static final ResourceLocation ORGAN_ID = ResourceLocation.fromNamespaceAndPath(MOD_ID, "jiezegu");
    ...
    private static void playRefluxSound(Level level, LivingEntity attacker, LivingEntity target) {
        ...
        level.playSound(null, x, y, z, SoundEvents.GENERIC_SPLASH, source, 0.65f, 0.9f + level.getRandom().nextFloat() * 0.2f);
    }
