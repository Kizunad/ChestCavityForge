 ...
 * 实现应通过以下来源动态计算护幕参数：
 * <ul>
 *   <li>道痕等级 (Sword Trail Level)</li>
 *   <li>流派经验 (Sect Experience)</li>
 *   <li>玩家当前 debuff 与 buff</li>
 *   <li>全局配置参数</li>
 * </ul>
 *
 * <h3>设计原则</h3>
 * <ul>
 *   <li>所有方法应返回合理的默认值，避免抛出异常</li>
 *   <li>参数计算应快速（避免复杂查询）</li>
 *   <li>支持配置热加载（实现可缓存计算结果）</li>
 * </ul>
 */
public interface WardTuning {
     ...
     * <ul>
     *   <li>道痕=0, 经验=0 → N=1</li>
     *   <li>道痕=400, 经验=2000 → N=1+2+2=5 → clamp到最大值</li>
     * </ul>
     *
     * @param owner 玩家 UUID
     ...
     * 示例值：
     * <ul>
     *   <li>道痕=0, 经验=0 → vMax=6.0 m/s</li>
     *   <li>道痕=100, 经验=1000 → vMax=6.0+2.0+1.0=9.0 m/s</li>
     * </ul>
     *
     * @param owner 玩家 UUID
     * @return 最大速度（米/秒）
     ...
     * 示例值：
     * <ul>
     *   <li>经验=0 → 0.06s (3 tick)</li>
     *   <li>经验=800 → 0.02s (1 tick, 下限)</li>
     * </ul>
     *
     * @param owner 玩家 UUID
     * @return 反应延迟（秒）
     ...
     * 示例值：
     * <ul>
     *   <li>经验=0 → R=0 → cost=8</li>
     *   <li>经验=2000 → R=0.5 → cost=4</li>
     *   <li>经验=10000 → R=0.6 → cost=3</li>
     * </ul>
     *
     * @param owner 玩家 UUID
     * @return 拦截耐久消耗
     ...
     * 示例值：
     * <ul>
     *   <li>经验=0 → R=0 → cost=10</li>
     *   <li>经验=2000 → R=0.5 → cost=5</li>
     *   <li>经验=10000 → R=0.6 → cost=4</li>
     * </ul>
     *
     * @param owner 玩家 UUID
     * @return 反击耐久消耗
     ...
     * 示例值：
     * <ul>
     *   <li>经验=0 → R=0 → cost=2</li>
     *   <li>经验=2000 → R=0.5 → cost=2 * 0.75 = 1</li>
     *   <li>经验=10000 → R=0.6 → cost=2 * 0.7 = 1</li>
     * </ul>
     *
     * @param owner 玩家 UUID
     * @return 失败耐久消耗
     ...
     * 示例值：
     * <ul>
     *   <li>道痕=0, 经验=0 → D=5.0</li>
     *   <li>道痕=100, 经验=1000 → D=5.0+5.0+10.0=20.0</li>
     * </ul>
     *
     * @param owner 玩家 UUID
     * @return 反击伤害（生命值）
     ...
     * 示例值：
     * <ul>
     *   <li>道痕=0, 经验=0 → Dur0=60</li>
     *   <li>道痕=100, 经验=1000 → Dur0=60+30+100=190</li>
     * </ul>
     *
     * @param owner 玩家 UUID
     * @return 初始耐久值
