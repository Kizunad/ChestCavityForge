...
public final class YuShiSummonTuning {
  ...
  public static final ResourceLocation ABILITY_ID =
      ResourceLocation.fromNamespaceAndPath(MOD_ID, "yu_shi_summon");
  ...
  public static final TagKey<Item> MATERIALS_TAG =
      TagKey.create(
          BuiltInRegistries.ITEM.key(),
          ResourceLocation.fromNamespaceAndPath(MOD_ID, "shark_materials"));
  public static final TagKey<Item> TIER1_TAG =
      TagKey.create(
          BuiltInRegistries.ITEM.key(),
          ResourceLocation.fromNamespaceAndPath(MOD_ID, "shark_materials_tiered/tier1"));
  public static final TagKey<Item> TIER2_TAG =
      TagKey.create(
          BuiltInRegistries.ITEM.key(),
          ResourceLocation.fromNamespaceAndPath(MOD_ID, "shark_materials_tiered/tier2"));
  public static final TagKey<Item> TIER3_TAG =
      TagKey.create(
          BuiltInRegistries.ITEM.key(),
          ResourceLocation.fromNamespaceAndPath(MOD_ID, "shark_materials_tiered/tier3"));
  public static final TagKey<Item> TIER4_TAG =
      TagKey.create(
          BuiltInRegistries.ITEM.key(),
          ResourceLocation.fromNamespaceAndPath(MOD_ID, "shark_materials_tiered/tier4"));
  public static final TagKey<Item> TIER5_TAG =
      TagKey.create(
          BuiltInRegistries.ITEM.key(),
          ResourceLocation.fromNamespaceAndPath(MOD_ID, "shark_materials_tiered/tier5"));

  public static final ResourceLocation[] TIER_ENTITY_IDS =
  ...
  public static final Map<ResourceLocation, Integer> FALLBACK_MATERIAL_TIERS =
      Map.ofEntries(
