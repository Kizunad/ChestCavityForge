...
public final class GuzhenrenLiupaiSync {
    ...
    private static final List<String> LIUPAI_FIELDS = List.of(
            "liupai_jindao", "liupai_shuidao", "liupai_mudao", "liupai_yandao",
            "liupai_tudao", "liupai_fengdao", "liupai_guangdao", "liupai_andao",
            "liupai_leidao", "liupai_dudao", "liupai_yudao", "liupai_zhoudao",
            "liupai_rendao", "liupai_tiandao", "liupai_bingxuedao", "liupai_qidao",
            "liupai_nudao", "liupai_zhidao", "liupai_xingdao", "liupai_zhendao",
            "liupai_yingdao", "liupai_lvdao", "liupai_liandao", "liupai_lidao",
            "liupai_shidao", "liupai_huadao", "liupai_toudao", "liupai_yundao",
            "liupai_yundao2", "liupai_xindao", "liupai_yindao", "Liupai_gudao",
            "liupai_xudao", "liupai_jindao2", "liupai_jiandao", "liupai_daodao",
            "liupai_hundao", "liupai_dandao", "liupai_xuedao", "liupai_huandao",
            "liupai_yuedao", "liupai_mengdao", "liupai_bingdao", "liupai_bianhuadao"
    );
