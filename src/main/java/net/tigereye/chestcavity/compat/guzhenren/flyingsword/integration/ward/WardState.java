 ...
 * 护幕飞剑的状态机
 * <p>
 * 护幕飞剑在不同状态间切换，以实现拦截和反击功能：
 * <ul>
 *   <li>{@link #ORBIT} - 环绕主人，待命状态</li>
 *   <li>{@link #INTERCEPT} - 向拦截点移动，时间窗口内（0.1-1.0秒）</li>
 *   <li>{@link #COUNTER} - 反击完成，仅当距离 ≤ 5m 时触发</li>
 *   <li>{@link #RETURN} - 返回环绕位置</li>
 * </ul>
 *
 * 状态转换流程：
 * <pre>
