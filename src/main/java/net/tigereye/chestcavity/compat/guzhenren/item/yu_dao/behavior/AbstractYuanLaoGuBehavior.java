...
abstract class AbstractYuanLaoGuBehavior implements OrganSlowTickListener {
  ...
  private double maybeRegenerate(
      ChestCavityInstance cc, ItemStack organ, double cap, double currentBalance) {
  ...
  protected enum AuxiliaryResource {
    JINGLI(
        ...
        BehaviorConfigAccess.getFloat(
            AbstractYuanLaoGuBehavior.class, "JINGLI_RECOVERY_EFFICIENCY", 0.2f),
        BehaviorConfigAccess.getFloat(
            AbstractYuanLaoGuBehavior.class, "JINGLI_RECOVERY_TRIGGER_RATIO", 0.5f),
    ...
    HUNPO(
        ...
        BehaviorConfigAccess.getFloat(
            AbstractYuanLaoGuBehavior.class, "HUNPO_RECOVERY_EFFICIENCY", 0.1f),
        BehaviorConfigAccess.getFloat(
            AbstractYuanLaoGuBehavior.class, "HUNPO_RECOVERY_TRIGGER_RATIO", 0.5f),
    ...
    NIANTOU(
        ...
        BehaviorConfigAccess.getFloat(
            AbstractYuanLaoGuBehavior.class, "NIANTOU_RECOVERY_EFFICIENCY", 0.05f),
        BehaviorConfigAccess.getFloat(
            AbstractYuanLaoGuBehavior.class, "NIANTOU_RECOVERY_TRIGGER_RATIO", 0.5f),
    ...
    private final BiFunction<GuzhenrenResourceBridge.ResourceHandle, Double, OptionalDouble>
        adjuster;
    ...
    double process(
      ...
      boolean enabledByConfig =
          BehaviorConfigAccess.getBoolean(
              AbstractYuanLaoGuBehavior.class, enableKey, enableDefault);
      if (!enabledByBehavior && !enabledByConfig) {
        return Math.max(
            0.0,
            Double.isFinite(stoneBalanceHint)
                ? stoneBalanceHint
                : YuanLaoGuHelper.readAmount(organ));
      }
      double stoneBalance =
          Math.max(
              0.0,
    ...
    private double drainExcess(
      ...
      double desiredResource =
          Math.min(currentValue * RESOURCE_CONVERT_PERCENT, stoneCapacity * resourcePerStone);
