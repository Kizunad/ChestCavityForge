...
public class SwordShadowClone extends PathfinderMob {
  ...
  private static final EntityDataAccessor<Optional<UUID>> OWNER =
      SynchedEntityData.defineId(SwordShadowClone.class, EntityDataSerializers.OPTIONAL_UUID);
  private static final EntityDataAccessor<Integer> COLOR =
      SynchedEntityData.defineId(SwordShadowClone.class, EntityDataSerializers.INT);
  private static final EntityDataAccessor<String> TEXTURE =
      SynchedEntityData.defineId(SwordShadowClone.class, EntityDataSerializers.STRING);
  ...
  private LivingEntity getTargetEntity(Player owner) {
    ...
    List<LivingEntity> candidates =
        this.level()
            .getEntitiesOfClass(LivingEntity.class, area, entity -> isValidTarget(owner, entity));
  ...
  public void setSkin(PlayerSkinUtil.SkinSnapshot snapshot) {
    ...
    int argb =
        ((int) (snapshot.alpha() * 255) & 0xFF) << 24
  ...
  private void rebuildSkinFromData() {
    ...
    this.skinTint =
        new PlayerSkinUtil.SkinSnapshot(
            null, null, getSkinTexture(), getSkinModel(), null, "", "", red, green, blue, alpha);
  }
