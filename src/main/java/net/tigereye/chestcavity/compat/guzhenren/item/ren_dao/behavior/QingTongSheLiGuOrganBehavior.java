...
/**
 * 青铜舍利蛊：
 * - 被动：每10秒清除一次晕眩/失明等精神负面（CONFUSION/BLINDNESS）
 * - 主动（ATTACKABILITY）：静心入定，3秒无法移动但获得抗性II，冷却25秒
 */
public enum QingTongSheLiGuOrganBehavior implements OrganSlowTickListener {
    INSTANCE;

    private static final String MOD_ID = "guzhenren";
    private static final ResourceLocation ORGAN_ID = ResourceLocation.fromNamespaceAndPath(MOD_ID, "qing_tong_she_li_gu");
    ...
    public static void activateAbility(LivingEntity entity, ChestCavityInstance cc) {
        ...
        // 应用3秒定身与抗性II
        entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, ACTIVE_DURATION_TICKS, SLOW_AMP, false, true, true));
