...
/**
 * Hard-coded registry of Guzhenren organs/items whose JSON declare a strength score. Generated via
 * script扫描 data/chestcavity/organs/guzhenren.
 */
public final class StrengthOrganRegistry {

  private static final Set<ResourceLocation> STRENGTH_ORGANS =
      Set.of(
