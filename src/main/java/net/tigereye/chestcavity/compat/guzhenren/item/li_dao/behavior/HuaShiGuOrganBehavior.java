...
/** 花豕蛊（力道·肌肉）： 被动：每 5 秒尝试消耗 200 BASE 真元，为拥有者恢复 3 精力。 主动：消耗 300 BASE 真元，获得 10 秒力量 III。 */
public final class HuaShiGuOrganBehavior extends AbstractLiDaoOrganBehavior
  ...
  private static final int PASSIVE_INTERVAL_TICKS =
      BehaviorConfigAccess.getInt(HuaShiGuOrganBehavior.class, "PASSIVE_INTERVAL_TICKS", 5 * 20);
  ...
  private static final double ACTIVE_BASE_ZHENYUAN_COST =
      BehaviorConfigAccess.getFloat(
          HuaShiGuOrganBehavior.class, "ACTIVE_BASE_ZHENYUAN_COST", 300.0f);
  private static final int ACTIVE_DURATION_TICKS =
      BehaviorConfigAccess.getInt(HuaShiGuOrganBehavior.class, "ACTIVE_DURATION_TICKS", 10 * 20);
  private static final int ACTIVE_STRENGTH_LEVEL =
      BehaviorConfigAccess.getInt(HuaShiGuOrganBehavior.class, "ACTIVE_STRENGTH_LEVEL", 3);
  ...
  private static void activateAbility(LivingEntity entity, ChestCavityInstance cc) {
    ...
    player.addEffect(
        new MobEffectInstance(
            MobEffects.DAMAGE_BOOST, ACTIVE_DURATION_TICKS, amplifier, false, true, true));
    player
        .level()
        .playSound(
            null,
