...
public final class WardSwordDebugHelper {
    ...
    ChestCavityEntity.of(player)
        .ifPresentOrElse(
            ccEntity -> {
              ...
              LOGGER.info(
                  "✓ ChestCavity inventory exists, size: {}", cc.inventory.getContainerSize());
  ...
  private static boolean hasBlockShieldOrganDebug(Player player) {
    ResourceLocation BLOCKSHIELD_ORGAN_ID =
        ResourceLocation.fromNamespaceAndPath("guzhenren", "blockshield");
