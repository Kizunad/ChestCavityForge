...
public final class DamageResult {
  ...
  public List<Entry> breakdown() {
    return breakdown;
  }

  public double predictedAbsorptionSpent() {
    return predictedAbsorptionSpent;
  }

  public double predictedHealthDamage() {
    return predictedHealthDamage;
  }
}
