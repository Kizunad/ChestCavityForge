...
public class CCRecipes {
  ...
  public static final DeferredHolder<
          RecipeSerializer<?>, SimpleCraftingRecipeSerializer<InfuseVenomGland>>
      INFUSE_VENOM_GLAND =
          RECIPE_SERIALIZERS.register(
              "crafting_special_infuse_venom_gland",
              () -> new SimpleCraftingRecipeSerializer<>(InfuseVenomGland::new));
  ...
  public static final DeferredHolder<RecipeSerializer<?>, SalvageRecipeSerializer>
      SALVAGE_RECIPE_SERIALIZER =
