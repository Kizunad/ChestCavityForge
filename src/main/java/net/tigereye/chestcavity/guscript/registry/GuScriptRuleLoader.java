...
public final class GuScriptRuleLoader extends SimpleJsonResourceReloadListener {
  ...
  private static ReactionRule parseRule(ResourceLocation id, JsonObject json) {
    ...
    String operatorId =
        result.has("operator_id") ? result.get("operator_id").getAsString() : id.toString();
    GuNodeKind kind =
        result.has("kind") ? parseKind(result.get("kind").getAsString()) : GuNodeKind.OPERATOR;
    ...
    final JsonObject exports =
        result.has("export_modifiers") ? result.getAsJsonObject("export_modifiers") : null;
    final boolean exportMultiplier =
        exports != null && exports.has("multiplier") && exports.get("multiplier").getAsBoolean();
    final boolean exportFlat =
        exports != null && exports.has("flat") && exports.get("flat").getAsBoolean();
