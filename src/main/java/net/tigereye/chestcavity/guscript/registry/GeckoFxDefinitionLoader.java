    ...
    protected void apply(Map<ResourceLocation, JsonElement> object, ResourceManager resourceManager, ProfilerFiller profiler) {
        ...
        object.forEach((id, element) -> {
            try {
                ...
                String defaultAnimation = json.has("default_animation")
                ...
                BlendMode blendMode = BlendMode.fromString(GsonHelper.getAsString(json, "blend", "translucent"), BlendMode.TRANSLUCENT);
                GeckoFxDefinition definition = new GeckoFxDefinition(id, model, texture, animation, defaultAnimation, defaultScale, defaultTint, defaultAlpha, blendMode);
