...
/**
 * Adjusts a Guzhenren resource (e.g., zhenyuan/jingli) by a signed amount.
 * Positive increases, negative consumes. No-op for non-players or missing attachments.
 */
public record AdjustGuzhenrenResourceAction(String identifier, double amount) implements Action {
    ...
    public void execute(GuScriptContext context) {
        ...
        GuzhenrenResourceBridge.open(performer).ifPresent(handle -> handle.adjustDouble(identifier, amount, true));
    }
}
