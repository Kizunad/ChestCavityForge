...
/**
 * Runs nested actions only if the performer has at least the given amount of the specified
 * resource. Resource identifier follows GuzhenrenResourceBridge string aliases (e.g., "zhenyuan",
 * "jingli").
 */
public record IfResourceAction(String identifier, double minimum, List<Action> actions)
    implements Action {
