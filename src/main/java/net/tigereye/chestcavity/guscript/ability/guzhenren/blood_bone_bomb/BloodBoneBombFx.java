...
public final class BloodBoneBombFx {
  ...
  public static final ResourceLocation CHARGE_HEARTBEAT =
      ChestCavity.id("blood_bone_charge_heartbeat");
  public static final ResourceLocation CHARGE_FAILURE = ChestCavity.id("blood_bone_charge_failure");
  public static final ResourceLocation PROJECTILE_LAUNCH =
      ChestCavity.id("blood_bone_projectile_launch");
  public static final ResourceLocation PROJECTILE_IMPACT =
      ChestCavity.id("blood_bone_projectile_impact");
  public static final ResourceLocation PROJECTILE_FADE =
      ChestCavity.id("blood_bone_projectile_fade");
