...
public final class ActionRegistry {
  ...
  public static void registerDefaults() {
    ...
    register(
        ConsumeZhenyuanAction.ID, json -> new ConsumeZhenyuanAction(json.get("amount").getAsInt()));
    register(
        ConsumeHealthAction.ID, json -> new ConsumeHealthAction(json.get("amount").getAsInt()));
    register(
        EmitProjectileAction.ID,
        json ->
            new EmitProjectileAction(
                json.get("projectileId").getAsString(),
                json.get("damage").getAsDouble(),
                EmitProjectileAction.parseParameters(json)));
    register(
        AddDamageMultiplierAction.ID,
        json -> new AddDamageMultiplierAction(json.get("amount").getAsDouble()));
    register(
        AddFlatDamageAction.ID, json -> new AddFlatDamageAction(json.get("amount").getAsDouble()));
    register(
        ExportMultiplierModifierAction.ID,
        json -> new ExportMultiplierModifierAction(json.get("amount").getAsDouble()));
    register(
        ExportFlatModifierAction.ID,
        json -> new ExportFlatModifierAction(json.get("amount").getAsDouble()));
    register(
        ExportTimeScaleMultiplierAction.ID,
        json -> new ExportTimeScaleMultiplierAction(json.get("amount").getAsDouble()));
    register(
        ExportTimeScaleFlatAction.ID,
        json -> new ExportTimeScaleFlatAction(json.get("amount").getAsDouble()));
    register(
        TriggerFxAction.ID,
        json ->
            TriggerFxAction.from(
    ...
    register(
        net.tigereye.chestcavity.guscript.actions.AdjustGuzhenrenResourceAction.ID,
        json ->
            new net.tigereye.chestcavity.guscript.actions.AdjustGuzhenrenResourceAction(
                json.get("identifier").getAsString(), json.get("amount").getAsDouble()));
    register(
        net.tigereye.chestcavity.guscript.actions.GainHealthAction.ID,
        json ->
            new net.tigereye.chestcavity.guscript.actions.GainHealthAction(
                json.get("amount").getAsDouble()));
    register(
        net.tigereye.chestcavity.guscript.actions.MindShockAction.ID,
        json ->
            new net.tigereye.chestcavity.guscript.actions.MindShockAction(
                json.get("damage").getAsDouble(),
                json.has("range") ? json.get("range").getAsDouble() : 16.0D));
    register(
        net.tigereye.chestcavity.guscript.actions.EmitBloodBoneBombAction.ID,
        json ->
            new net.tigereye.chestcavity.guscript.actions.EmitBloodBoneBombAction(
                json.has("base") ? json.get("base").getAsDouble() : 80.0));
    register(
        net.tigereye.chestcavity.guscript.actions.ConditionalTargetAction.ID,
        json ->
            new net.tigereye.chestcavity.guscript.actions.ConditionalTargetAction(
                ...
                readActions(json)));
    register(
        net.tigereye.chestcavity.guscript.actions.IfItemUseAction.ID,
        json ->
            new net.tigereye.chestcavity.guscript.actions.IfItemUseAction(
                ...
                readActions(json)));
    register(
        net.tigereye.chestcavity.guscript.actions.IfResourceAction.ID,
        json ->
            new net.tigereye.chestcavity.guscript.actions.IfResourceAction(
                ...
                readActions(json)));
    register(
        net.tigereye.chestcavity.guscript.actions.AdjustLinkageChannelAction.ID,
        json ->
            new net.tigereye.chestcavity.guscript.actions.AdjustLinkageChannelAction(
                ...
                json.get("amount").getAsDouble()));
    register(
        net.tigereye.chestcavity.guscript.actions.AdjustLinkageChannelTemporaryAction.ID,
        json ->
    ...
    register(
        SoulBeastTransformAction.ID,
        json ->
            new SoulBeastTransformAction(
                json.has("source")
                    ? ResourceLocation.parse(json.get("source").getAsString())
                    : null));
    register(
        HunShouHuaPredicateAction.ID,
        json ->
            new HunShouHuaPredicateAction(
                readActions(json, "if_used"), readActions(json, "if_unused")));
  }
