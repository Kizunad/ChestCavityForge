...
public final class GuScriptReducerDebug {
  ...
  public static void logDemo() {
    ...
    GuNode blood =
        new LeafGuNode("血蛊", ImmutableMultiset.of("血"), List.of(new ConsumeZhenyuanAction(3)));
    GuNode burst =
        new LeafGuNode(
            "爆发蛊",
            ImmutableMultiset.of("爆发"),
            List.of(new EmitProjectileAction("explosion_shard", 6.0)));
            ...
            .operator(
                (ruleId, inputs) ->
                    new OperatorGuNode(
                        ...
                        unionTags(inputs, "杀招"),
                        List.of(new EmitProjectileAction("blood_burst", 12.0)),
                        inputs))
            .build();
