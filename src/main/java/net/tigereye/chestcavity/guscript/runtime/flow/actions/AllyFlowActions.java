...
final class AllyFlowActions {
  ...
  static FlowEdgeAction tameNearby(double radius, boolean sit, boolean persist) {
    ...
    return new FlowEdgeAction() {
      ...
      public String describe() {
        return "tame_nearby(r=" + r + ", sit=" + sit + ")";
      }
    };
  }
  ...
  static FlowEdgeAction orderGuard(double radius, boolean seekHostiles, double acquireRadius) {
    ...
    return new FlowEdgeAction() {
          ...
          if (seekHostiles && ally instanceof Mob mob) {
            ...
            List<LivingEntity> hostiles =
                server.getEntitiesOfClass(
                    LivingEntity.class,
                    search,
                    e -> e instanceof Enemy && e.isAlive() && e != performer);
      ...
      @Override
      public String describe() {
        return "order_guard(r=" + r + ", seek=" + seekHostiles + ", ar=" + ar + ")";
      }
    };
  }
  ...
  static FlowEdgeAction bindOwnerNudao(double radius, boolean alsoTameIfPossible) {
    ...
    return new FlowEdgeAction() {
      ...
      @Override
      public String describe() {
        return "bind_owner_nudao(r=" + r + ", tameIfPossible=" + alsoTameIfPossible + ")";
      }
    };
  }

  static FlowEdgeAction assistPlayerAttacks(
    ...
    return new FlowEdgeAction() {
      ...
      @Override
      public String describe() {
        return "assist_player_attacks(r=" + r + ", window=" + window + ", ar=" + ar + ")";
      }
    };
  }
  ...
  static FlowEdgeAction setInvisibleNearby(double radius, boolean invisible, boolean alliesOnly) {
    ...
    return new FlowEdgeAction() {
      ...
      @Override
      public String describe() {
        return "set_invisible_nearby(r=" + r + ", alliesOnly=" + alliesOnly + ")";
      }
    };
  }
}
