...
public class CCConfig implements ConfigData {
  ...
  @ConfigEntry.Category("core")
  public int CHEST_OPENER_ABSOLUTE_HEALTH_THRESHOLD =
      20; // health below which a chest can be opened

  @ConfigEntry.Category("core")
  public float CHEST_OPENER_FRACTIONAL_HEALTH_THRESHOLD =
      .5f; // health below which a chest can be opened
  ...
  @ConfigEntry.Category("more")
  public int CRYSTALSYNTHESIS_FREQUENCY =
      10; // how often the link to an End Crystal is updated and perks gained
  ...
  @ConfigEntry.Category("more")
  public float IRON_REPAIR_PERCENT =
      .25f; // damage reduction from 4 stacks of impact resistant organs
  ...
  @ConfigEntry.Category("more")
  public int PHOTOSYNTHESIS_FREQUENCY =
      50; // how many ticks 8 photosynthetic organs in direct sunlight need to restore 1 hunger
  ...
  @ConfigEntry.Category("guzhenren_behavior")
  @ConfigEntry.Gui.Tooltip
  public boolean GUZHENREN_ROU_BAIGU_REQUIRE_EMPTY_SLOT = false;
  ...
  public static class GuScriptUIConfig {
    @ConfigEntry.Gui.Tooltip public double bindingRightPaddingSlots = 0.5D;
    @ConfigEntry.Gui.Tooltip public double bindingTopPaddingSlots = 1.5D;
    @ConfigEntry.Gui.Tooltip public double bindingVerticalSpacingSlots = 0.35D;
    @ConfigEntry.Gui.Tooltip public double bindingButtonWidthFraction = 0.56D;
    @ConfigEntry.Gui.Tooltip public int bindingButtonHeightPx = 20;
    @ConfigEntry.Gui.Tooltip public int minBindingButtonWidthPx = 0;
    @ConfigEntry.Gui.Tooltip public int bindingVerticalOffsetPx = 10;
    @ConfigEntry.Gui.Tooltip public int minTopGutterPx = 0;
    @ConfigEntry.Gui.Tooltip public int minHorizontalGutterPx = 6;
    @ConfigEntry.Gui.Tooltip public int minBindingSpacingPx = 0;
    @ConfigEntry.Gui.Tooltip public int pageButtonWidthPx = 20;
    @ConfigEntry.Gui.Tooltip public int pageButtonHeightPx = 20;
    @ConfigEntry.Gui.Tooltip public double pageButtonLeftPaddingSlots = 0.8D;
    @ConfigEntry.Gui.Tooltip public double pageButtonTopPaddingSlots = 0.9D;
    @ConfigEntry.Gui.Tooltip public double pageButtonHorizontalSpacingSlots = 0.2D;
    @ConfigEntry.Gui.Tooltip public int minPageButtonSpacingPx = 0;
    @ConfigEntry.Gui.Tooltip public int pageButtonHorizontalOffsetPx = -50;
    @ConfigEntry.Gui.Tooltip public int pageInfoBelowNavSpacingPx = 6;
  }

  public static class GuScriptExecutionConfig {
    @ConfigEntry.Gui.Tooltip public int maxKeybindPagesPerTrigger = 16;
    @ConfigEntry.Gui.Tooltip public int maxKeybindRootsPerTrigger = 64;
    @ConfigEntry.Gui.Tooltip public double maxCumulativeMultiplier = 5.0D;
    @ConfigEntry.Gui.Tooltip public double maxCumulativeFlat = 20.0D;

    @ConfigEntry.Gui.Tooltip
    public boolean enableFlows =
        true; // toggle flow integration; when false, all roots execute immediately

    @ConfigEntry.Gui.Tooltip
    public boolean enableFlowQueue = true; // default off to preserve legacy single-flow behavior

    @ConfigEntry.Gui.Tooltip public int maxFlowQueueLength = 40;
    @ConfigEntry.Gui.Tooltip public boolean revalidateQueuedGuards = true;
    @ConfigEntry.Gui.Tooltip public int queuedGuardRetryLimit = 0;

    @ConfigEntry.Gui.Tooltip
    public TimeScaleCombineStrategy timeScaleCombine = TimeScaleCombineStrategy.MULTIPLY;

    @ConfigEntry.Gui.Tooltip
    public boolean preferUiOrder =
        true; // prioritize page/slot ordering over compilation order when available
  }
  ...
  public static class SwordSlashConfig {
    @ConfigEntry.Gui.Tooltip public double defaultLength = 7.5D;
    @ConfigEntry.Gui.Tooltip public double defaultThickness = 0.9D;
    @ConfigEntry.Gui.Tooltip public int defaultLifespanTicks = 12;
    @ConfigEntry.Gui.Tooltip public double defaultDamage = 10.0D;
    @ConfigEntry.Gui.Tooltip public double defaultBreakPower = 1.5D;
    @ConfigEntry.Gui.Tooltip public int defaultMaxPierce = 3;
    @ConfigEntry.Gui.Tooltip public boolean enableBlockBreaking = true;
    @ConfigEntry.Gui.Tooltip public int blockBreakCapPerTick = 6;
    @ConfigEntry.Gui.Tooltip public boolean debugLogging = false;
  ...
  public static class SwordSlashVisualConfig {
    @ConfigEntry.Gui.Tooltip public int slashColor = 0xFFE0A0;
    @ConfigEntry.Gui.Tooltip public double slashAlpha = 0.85D;
    @ConfigEntry.Gui.Tooltip public double slashEndAlpha = 0.3D;
  }

  public static class GuzhenrenBingXueDaoConfig {

    @ConfigEntry.Gui.CollapsibleObject public BingJiGuConfig BING_JI_GU = new BingJiGuConfig();

    @ConfigEntry.Gui.CollapsibleObject public QingReGuConfig QING_RE_GU = new QingReGuConfig();

    @ConfigEntry.Gui.CollapsibleObject
    public ShuangXiGuConfig SHUANG_XI_GU = new ShuangXiGuConfig();

    @ConfigEntry.Gui.CollapsibleObject public BingBuGuConfig BING_BU_GU = new BingBuGuConfig();
  ...
  public static class ReactionConfig {
    ...
    @ConfigEntry.Gui.CollapsibleObject public HuoTanConfig HUO_TAN = new HuoTanConfig();
  }
