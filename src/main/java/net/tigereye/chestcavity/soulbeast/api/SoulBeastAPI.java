...
/**
 * @deprecated 迁移至 {@link
 *     net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.api.SoulBeastAPI}
 */
...
public final class SoulBeastAPI {
  ...
  public static boolean toSoulBeast(
    ...
    return net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.api.SoulBeastAPI
        .toSoulBeast(entity, permanent, source);
  }

  public static boolean clearSoulBeast(LivingEntity entity) {
    return net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.api.SoulBeastAPI
        .clearSoulBeast(entity);
  }
