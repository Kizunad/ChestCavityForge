...
/**
 * @deprecated 迁移至 {@link
 *     net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.state.SoulBeastState}
 */
@Deprecated(forRemoval = true)
public final class SoulBeastState {

  private final net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.state
          .SoulBeastState
      delegate;

  public SoulBeastState() {
    this(
        new net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.state
            .SoulBeastState());
  }
