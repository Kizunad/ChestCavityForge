...
/**
 * @deprecated 迁移至 {@link
 *     net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.storage.BeastSoulRecord}
 */
...
public record BeastSoulRecord(
  ...
  public net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.storage.BeastSoulRecord
      toCompat() {
    return new net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.storage
        .BeastSoulRecord(
        entityTypeId, entityData == null ? new CompoundTag() : entityData.copy(), storedGameTime);
  }

  static BeastSoulRecord fromCompat(
      net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.storage.BeastSoulRecord
          record) {
