...
/**
 * @deprecated 迁移至 {@link net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.storage.ItemBeastSoulStorage}
 */
@Deprecated(forRemoval = true)
public final class ItemBeastSoulStorage implements BeastSoulStorage {

    private final net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.storage.ItemBeastSoulStorage delegate;

    public ItemBeastSoulStorage() {
        this.delegate = new net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.storage.ItemBeastSoulStorage();
    }

    public ItemBeastSoulStorage(String rootKey) {
        this.delegate = new net.tigereye.chestcavity.compat.guzhenren.util.hun_dao.soulbeast.storage.ItemBeastSoulStorage(rootKey);
    }
    ...
    @Override
    public Optional<BeastSoulRecord> store(ItemStack organ, LivingEntity entity, long storedGameTime) {
