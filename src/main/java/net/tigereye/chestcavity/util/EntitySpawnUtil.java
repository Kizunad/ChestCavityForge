...
public final class EntitySpawnUtil {
    ...
    /**
     * Spawns an entity by id at the given position and rotation.
     * Returns the entity if spawned, or null on failure.
     */
    public static Entity spawn(ServerLevel level, ResourceLocation entityId, Vec3 pos, float yaw, float pitch, boolean noAi) {
