...
/** General combat helpers used by both core ChestCavity logic and Guzhenren integrations. */
public final class CombatUtil {
   ...
   * vector when available, otherwise a random heading is used. The motion is applied via {@link
   * LivingEntity#push} so that vanilla movement syncing is preserved.
   */
   ...
   */
  public static void applyRandomAttackOffset(
      LivingEntity attacker, float yawRangeDeg, float pitchRangeDeg, double intensity) {
