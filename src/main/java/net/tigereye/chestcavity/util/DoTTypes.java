...
/**
 * 统一的 DoT 类型标识符集合，便于分类与诊断。
 * 命名规范："dot/<domain>_<name>" 或 "dot/<group>/<name>"。
 */
public final class DoTTypes {
    ...
    public static final ResourceLocation ATTACK_BASE_PERCENT = ChestCavity.id("dot/attack_base_percent");

    // Guzhenren 系列（示例：魂道/冰雪道/云道）
    public static final ResourceLocation HUN_DAO_SOUL_FLAME = ChestCavity.id("dot/hun_dao_soul_flame");
    ...
    public static final ResourceLocation YAN_DAO_DRAGONFLAME = ChestCavity.id("dot/yan_dao_dragonflame");
    public static final ResourceLocation LEI_DAO_ELECTRIC_SHOCK = ChestCavity.id("dot/lei_dao_electric_shock");
