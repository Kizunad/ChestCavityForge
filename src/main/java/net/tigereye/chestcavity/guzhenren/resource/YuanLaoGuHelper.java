...
/**
 * Utilities for reading and modifying the Yuan Lao Gu item’s stored Yuan Shi amount. This tool
 * operates directly on the ItemStack’s CustomData keys used by Guzhenren.
 */
public final class YuanLaoGuHelper {
  ...
  /**
   * Sets the stored amount, clamped to [0, capacity] when capacity key exists. Returns the value
   * actually written.
   */
  ...
  /**
   * Updates the item’s custom display name to mirror Guzhenren’s format (e.g., “元老蛊 (元石数量:XXX)”).
