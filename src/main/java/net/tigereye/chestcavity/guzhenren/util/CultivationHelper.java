...
/**
 * 小境界阶段与转数推进的最小规则：
 * - 当 "蛊师当前修炼进度" 达到/超过 "蛊师所需修炼进度" 时：当前进度清零，{@code jieduan}+1。
 * - 当 {@code jieduan} 达到 {@link #MAX_JIEDUAN_PER_TURN}（默认 5）时：{@code zhuanshu}+1，{@code jieduan} 清零。
 */
public final class CultivationHelper {
     ...
     */
    public static void tickProgress(GuzhenrenResourceBridge.ResourceHandle handle, double progressDelta) {
