...
/**
 * Guards a ServerPlayer against incoming damage during sensitive switch phases (teleport +
 * capability apply + base restore).
 */
...
public final class SoulSwitchGuard {
  ...
  public static void onIncomingDamage(LivingIncomingDamageEvent event) {
    ...
    SoulLog.info(
        "[soul] switch-guard canceled damage owner={} type={} amount={}",
        player.getUUID(),
        event
            .getSource()
            .typeHolder()
