...
/**
 * Minimal Action contract for FakePlayer autonomy.
 * Stateless implementations preferred; persist run state via ActionStateManager.
 */
public interface Action {
    ...
    /**
     * Execute a small step. Must be cheap and non-blocking.
     * Return RUNNING to continue later, SUCCESS/FAILED/CANCELLED to finish.
     */
    ...
    default String cooldownKey() { return null; }

    /**
     * Next time to run in server ticks. Use to avoid per-tick busy loops.
     * Return now or now+N; planner will schedule the next tick accordingly.
     */
