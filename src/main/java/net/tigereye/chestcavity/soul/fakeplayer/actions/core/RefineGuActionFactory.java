...
/**
 * Parses ids like chestcavity:action/refine_gu/<ns>/<path> Example:
 * chestcavity:action/refine_gu/guzhenren/dazhigugufang
 */
public final class RefineGuActionFactory implements ActionFactory {
  ...
  public Action create(ResourceLocation id) {
    ...
    try {
      guFangId = ResourceLocation.fromNamespaceAndPath(gfNs, gfPath);
