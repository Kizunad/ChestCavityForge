...
public record SoulGenerationRequest(
    ...
    public SoulGenerationRequest withIdentity(@Nullable GameProfile identity, boolean forceDerivedIdentity) {
        return new SoulGenerationRequest(soulId, identity, forceDerivedIdentity, reason, initialMode, initialIntent);
    }
