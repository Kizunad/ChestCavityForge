...
public final class UseItemActionFactory implements ActionFactory {
    ...
    public Action create(ResourceLocation id) {
        ...
        if (seg.length >= 4) {
            ...
            if (h.startsWith("main")) hand = InteractionHand.MAIN_HAND; else hand = InteractionHand.OFF_HAND;
        }
        ResourceLocation itemId;
        try { itemId = ResourceLocation.fromNamespaceAndPath(itemNs, itemPath); } catch (IllegalArgumentException e) { return null; }
