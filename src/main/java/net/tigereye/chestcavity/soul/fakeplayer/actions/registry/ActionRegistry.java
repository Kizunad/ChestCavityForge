...
public final class ActionRegistry {
    ...
    private static final java.util.List<ActionFactory> FACTORIES = new java.util.concurrent.CopyOnWriteArrayList<>();
    ...
    public static void registerFactory(ActionFactory factory) { if (factory != null) FACTORIES.add(factory); }

    public static Action find(ResourceLocation id) { return ACTIONS.get(id); }
    public static Action find(ActionId id) { return find(id.id()); }
    ...
    public static Collection<Action> all() { return Collections.unmodifiableCollection(ACTIONS.values()); }
}
