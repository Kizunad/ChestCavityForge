...
public final class UseItemAction implements Action {
    ...
    public UseItemAction(ResourceLocation fullId, ResourceLocation itemId, String extra, InteractionHand hand) {
    ...
    @Override public boolean canRun(ActionContext ctx) { return ctx.soul().isAlive(); }
    @Override public void start(ActionContext ctx) { /* no-op */ }
    ...
    public ActionResult tick(ActionContext ctx) {
        ...
        ChestCavity.LOGGER.info("[soul][action][use_item] id={} item={} hand={} used={} hp:{}->{}", id, itemId, hand, used, before, after);
        return ActionResult.SUCCESS;
    }

    @Override public void cancel(ActionContext ctx) { /* single-shot */ }
    @Override public String cooldownKey() { return null; }
    @Override public long nextReadyAt(ActionContext ctx, long now) { return now; }
