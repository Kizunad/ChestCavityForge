...
public final class SoulActions {
  ...
  public static void bootstrap() {
    ...
    ActionRegistry.register(
        new net.tigereye.chestcavity.soul.fakeplayer.actions.core.CultivateAction());
    ActionRegistry.register(
        new net.tigereye.chestcavity.soul.fakeplayer.actions.core.RefineGuAction());
    ActionRegistry.registerFactory(
        new net.tigereye.chestcavity.soul.fakeplayer.actions.core.UseItemActionFactory());
    ActionRegistry.registerFactory(
        new net.tigereye.chestcavity.soul.fakeplayer.actions.core.RefineGuActionFactory());
  }
}
