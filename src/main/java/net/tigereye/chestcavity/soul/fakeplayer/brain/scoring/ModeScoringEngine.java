...
/**
 * Provides high-level scoring for each {@link BrainMode} using registered {@link
 * ModeUtilityProfile}s. The engine is stateless and can be shared.
 */
public final class ModeScoringEngine {
  ...
  public static ModeScoringEngine createDefault() {
    ...
    map.put(
        BrainMode.AUTO,
        ModeUtilityProfile.builder(BrainMode.AUTO)
    ...
    map.put(
        BrainMode.COMBAT,
        ModeUtilityProfile.builder(BrainMode.COMBAT)
    ...
    map.put(
        BrainMode.SURVIVAL,
        ModeUtilityProfile.builder(BrainMode.SURVIVAL)
    ...
    map.put(
        BrainMode.IDLE,
        ModeUtilityProfile.builder(BrainMode.IDLE)
    ...
    map.put(
        BrainMode.LLM,
        ModeUtilityProfile.builder(BrainMode.LLM)
