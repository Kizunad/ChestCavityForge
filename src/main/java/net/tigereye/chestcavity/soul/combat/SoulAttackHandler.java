...
/**
 * A pluggable combat action. Registry will iterate handlers in registration order and invoke the
 * first that is both in range and returns true from tryAttack.
 */
