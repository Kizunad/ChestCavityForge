...
public final class SoulFollowTeleportTuning {
    ...
    private static volatile double followTriggerDist = getDoubleProp("chestcavity.soul.followTriggerDist", 3.0, 1.0, 8.0);
    private static volatile boolean teleportEnabled = Boolean.parseBoolean(System.getProperty("chestcavity.soul.teleportEnabled", "true"));
    private static volatile double teleportDist = getDoubleProp("chestcavity.soul.teleportDist", 20.0, 8.0, 128.0);
