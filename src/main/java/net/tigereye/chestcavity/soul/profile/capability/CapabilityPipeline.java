...
public final class CapabilityPipeline {
  ...
  public static void captureAll(
      Map<ResourceLocation, CapabilitySnapshot> snapshots, ServerPlayer player) {
  ...
  public static CompoundTag save(
      Map<ResourceLocation, CapabilitySnapshot> snapshots, HolderLookup.Provider provider) {
  ...
  public static Map<ResourceLocation, CapabilitySnapshot> load(
    ...
    for (String key : tag.getAllKeys()) {
      ...
      try {
        ...
        ChestCavity.LOGGER.warn(
            "[soul] Ignored invalid capability snapshot id '{}' while loading", key);
        continue;
      }
      ...
      if (snapshot == null) {
        ...
        if (snapshot != null) {
          ...
          ChestCavity.LOGGER.warn(
              "[soul] Missing capability snapshot factory for id={} during load", id);
          continue;
        }
      }
