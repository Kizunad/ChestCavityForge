 ...
 *
 * 作用
 * - 为灵魂存档记录可恢复的基础状态，包含经验、饥饿三件套、生命/吸收、以及可同步属性的基值。
...
public record PlayerStatsSnapshot(
    ...
    public static PlayerStatsSnapshot load(CompoundTag tag, HolderLookup.Provider provider) {
        ...
        return new PlayerStatsSnapshot(level, progress, total, health, absorption, food, saturation, exhaustion, attributes);
    }
