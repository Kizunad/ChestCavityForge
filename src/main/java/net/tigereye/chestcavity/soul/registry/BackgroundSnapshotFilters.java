...
public final class BackgroundSnapshotFilters {
    ...
    private static final AtomicReference<BackgroundSnapshotFilter> ACTIVE = new AtomicReference<>(new Default());

    private BackgroundSnapshotFilters() {}

    public static BackgroundSnapshotFilter get() { return ACTIVE.get(); }
