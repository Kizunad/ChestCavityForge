 ...
 *
 * Usage:
 * - Call {@link #registerPerSecond(SoulPerSecondListener)} or {@link #registerPerMinute(SoulPerMinuteListener)}
 *   at mod init to install listeners.
 * - The dispatcher will invoke listeners once per SoulPlayer when the server gameTime crosses
 *   a 20-tick (1s) or 1200-tick (60s) boundary.
 */
