...
/**
 * Global registry for the active write policy. Keeps a single active policy reference with a
 * conservative default.
 */
public final class SoulWritePolicyRegistry {

  private static final AtomicReference<SoulWritePolicy> ACTIVE =
      new AtomicReference<>(new StrictPolicy());

  private SoulWritePolicyRegistry() {}

  public static SoulWritePolicy get() {
    return ACTIVE.get();
  }
