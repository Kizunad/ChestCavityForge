...
/**
 * Pluggable navigation engine interface for Soul navigation. Implementations must be side-effect
 * free w.r.t world entity spawning and apply movement only to the provided {@link SoulPlayer} in
 * {@link #tick}.
 */
