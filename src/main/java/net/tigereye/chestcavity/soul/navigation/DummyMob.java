 ...
 *
 * <p>IMPORTANT: Instances are never added to the Level. They only reference the Level for
...
final class DummyMob extends Mob {
  ...
  protected net.minecraft.world.entity.ai.navigation.PathNavigation createNavigation(Level level) {
    ...
    // Encourage small step-ups by enabling passing through doors and floating; jumping is handled
    // by path logic
