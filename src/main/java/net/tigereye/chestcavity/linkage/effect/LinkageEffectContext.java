 ...
 *
 * <p>Provides helper utilities for linkage effects so behaviour registration is concise and
 * consistent. The context is scoped to the current chest cavity evaluation pass.
 */
public interface LinkageEffectContext {
  ...
  /**
   * Returns a view of all organ stacks participating in the effect. The list may contain multiple
   * stacks when the requirement spans several organ items.
   */
