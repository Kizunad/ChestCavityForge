 ...
 *
 * <p>Callback invoked whenever a channel's value changes. Subscribers may treat this passively
 * (READ) by only observing values or actively (FOLLOW) by triggering additional side effects.
 */
@FunctionalInterface
