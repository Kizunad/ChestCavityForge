...
/**
 * Contract for organs or subsystems that can mitigate incoming damage. Implementations are expected
 * to mutate state (e.g. consume charge) and return the remaining damage after mitigation.
 */
