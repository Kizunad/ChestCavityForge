...
/**
 * Implemented by organs that provide generic healing. Implementations should be side-agnostic;
 * healing is applied server-side.
 */
public interface OrganHealListener {

  /**
   * Return the healing amount to apply this tick. - Return 0 for no healing. - Positive values heal
   * the owner (clamped by max health).
   *
